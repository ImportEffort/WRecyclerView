 ...
 */
package com.example.wsj.wrecyclerview.recyclerView.base;
...
public class BaseViewHolder extends RecyclerView.ViewHolder {
    ...
    public BaseViewHolder setImageUrl(int viewId, String url, Transformation transformation, @DrawableRes int imageResId) {
        ImageView view = getView(viewId);
        DrawableRequestBuilder<String> drawableTypeRequest = Glide.with(view.getContext().getApplicationContext()).load(url).placeholder(imageResId);
        if (transformation != null) {
            drawableTypeRequest.bitmapTransform(new CenterCrop(view.getContext()), transformation);
        } else {
    ...
    public BaseViewHolder setImageUrlWithErrorImage(int viewId, String url, Transformation transformation, @DrawableRes int imageResId,@DrawableRes int errorimageResId) {
        ImageView view = getView(viewId);
        DrawableRequestBuilder<String> drawableTypeRequest = Glide.with(view.getContext().getApplicationContext()).load(url).placeholder(imageResId);
        if (transformation != null) {
            drawableTypeRequest.bitmapTransform(new CenterCrop(view.getContext()), transformation);
        ...
        drawableTypeRequest.error(imageResId);
        drawableTypeRequest.into(view);
        return this;
    }

    public BaseViewHolder setImageUrl(int viewId, String url) {
        setImageUrl(viewId, url, null, -1);
        return this;
    }
    ...
    public BaseViewHolder setVisiblity(int viewId, boolean visible) {
        View view = getView(viewId);
